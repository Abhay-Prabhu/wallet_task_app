...
class SplashScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    String token =
        "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOiI2N2VjYzk0OGE0NTBiYzhhOTA1OGNlMzMiLCJfcGhvbmVOdW1iZXIiOiI3NjIwMTQ2Mzc5IiwidXNlclR5cGVJZCI6IjY3MGNhMGQ0NDllNGVmOGZmODRiM2U5NyIsInVzZXJUeXBlIjoibWF0Y2htYWtlciIsImlhdCI6MTc0NDI1MTcxNiwiZXhwIjoxNzQ0MjczMzE2fQ.zIlJYT8NF6ajeBxJorQFaTf-3NwpYpmV17pGSXEnkn0";
    return Scaffold(
      body: Padding(
