...
//       print("Data sent for deleting the payment redeem --otp: $otp , token : ${initialDeleteModel.token}, hashedOtp : ${initialDeleteModel.hashedOtp} ");
...
//     required InitiateEditPaymentModel initiateEditModel,
//   }) async {
//     try {
//       String message = initiateEditModel.message.toString();
//       final regex = RegExp(r'\b\d{6}\b');
//       final match = regex.firstMatch(message);
...
//       print("Data sent for Updating the payment redeem --otp: $otp , token : ${otp}, hashedOtp : ${initiateEditModel.hashedOtp} ");
//       final response = await _dio.put(
//         ApiEndPoints.updateRedeem,
//         data: {
//           "otp": otp,
//           "hashtedDetails": initiateEditModel.hashtedDetails,
//           "hashedOtp": initiateEditModel.hashedOtp,
//         },
//       );
//       if (response.statusCode == 200) {
//         print(
